...
public class TvetAdapter extends RecyclerView.Adapter<TvetAdapter.PopularSchoolViewHolder> {
    private Context context;
    private ArrayList<Model> modelArrayList;

    public TvetAdapter(Context context, ArrayList<Model>modelArrayList) {
