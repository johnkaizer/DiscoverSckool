...
public class HighAdapter extends RecyclerView.Adapter<HighAdapter.PopularSchoolViewHolder> {
    private Context context;
    private ArrayList<Model> modelArrayList;

    public HighAdapter(Context context, ArrayList<Model>modelArrayList) {
