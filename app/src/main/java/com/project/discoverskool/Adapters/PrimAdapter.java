...
public class PrimAdapter extends RecyclerView.Adapter<PrimAdapter.PopularSchoolViewHolder> {
    private Context context;
    private ArrayList<Model> modelArrayList;

    public PrimAdapter(Context context, ArrayList<Model>modelArrayList) {
